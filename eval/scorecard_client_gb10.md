...
**Generated:** 2026-08-27 11:34 UTC  
**Model:** `topaz-coder`  
...
|---|---|---|---|
| p50 (warm) | <= 4 s | 3.60 s | PASS |
| p95 (warm) | <= 10 s | 7.26 s | PASS |
| cold start (first query, model load) | reported separately | 9.40 s | - |
...
| 17 | ok | ok | 2 | - | ok | 6.5 s |  |
| 18 | ok | MISS | 1 | - | - | 4.3 s |  |
| 19 | MISS | MISS | 0 | MISS | - | 1.7 s | peer `telecom` unreachable — not scored |
| 20 | ok | ok | 2 | - | ok | 13.1 s |  |
| 21 | MISS | ok | 2 | - | ok | 4.6 s | peer `hospitality` unreachable — not scored |
| 22 | ok | ok | 0 | - | - | 1.7 s |  |
| 23 | - | - | 0 | - | - | 2.3 s | grounding gate blocked an ungrounded answer |
...
| 26 | - | - | 1 | ok | - | 4.2 s |  |
| 27 | - | - | 0 | ok | - | 3.4 s | grounding gate blocked an ungrounded answer |
