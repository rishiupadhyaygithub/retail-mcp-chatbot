...
**Generated:** 2026-08-27 12:06 UTC  
**Model:** `topaz-coder`  
...
| Citation accuracy | 100% | 100.0% | 17 | PASS |
...
|---|---|---|---|
| p50 (warm) | <= 4 s | 4.49 s | **FAILED** |
| p95 (warm) | <= 10 s | 11.25 s | **FAILED** |
| cold start (first query, model load) | reported separately | 10.18 s | - |
...
| 14 | ok | ok | 3 | - | - | 10.6 s |  |
| 15 | ok | ok | 2 | - | ok | 4.9 s |  |
| 16 | ok | ok | 2 | - | ok | 11.3 s |  |
| 17 | ok | ok | 2 | - | ok | 6.4 s |  |
| 18 | MISS | MISS | 0 | MISS | - | 1.5 s | grounding gate blocked an ungrounded answer |
| 19 | MISS | MISS | 1 | - | ok | 11.8 s | peer `telecom` unreachable — not scored |
| 20 | ok | ok | 2 | - | ok | 7.4 s |  |
| 21 | MISS | ok | 1 | - | ok | 4.5 s | peer `hospitality` unreachable — not scored |
| 22 | ok | ok | 1 | - | - | 1.5 s |  |
| 23 | - | - | 0 | - | - | 0.1 s |  |
...
| 25 | ok | ok | 1 | ok | - | 1.4 s |  |
| 26 | - | - | 0 | ok | - | 2.1 s | grounding gate blocked an ungrounded answer |
| 27 | - | - | 0 | ok | - | 1.9 s | grounding gate blocked an ungrounded answer |
| 28 | ok | ok | 1 | MISS | - | 1.7 s |  |
